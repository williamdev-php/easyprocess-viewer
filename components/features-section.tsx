...
function FeatureIcon({ index, colors, variantStyle, show_gradient = true }: { index: number; colors: Colors; variantStyle: VariantStyle; show_gradient?: boolean }) {
  return (
    <div
              ...
              >
                ...
                <div className="relative">
                  {f.icon ? (
                    ...
                    <FeatureIcon index={i} colors={colors} variantStyle={variantStyle} show_gradient={show_gradient} />
                  )}
